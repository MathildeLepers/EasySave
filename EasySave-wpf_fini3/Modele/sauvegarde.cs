...
namespace Livrable2.Modele
{
    public class sauvegarde
    {
        ...
        public static void sauvegarde_complet_Crypt(string source, string dest)
        {
            etat_file = State.INPROGRESS;
            ...
            foreach (var file in Directory.GetFiles(source))
            {
                ...
                string arg = source + Path.GetFileName(file) + " " + dest + Path.GetFileName(file);
                process.StartInfo.WindowStyle = ProcessWindowStyle.Maximized;
                process.StartInfo.FileName = @"C:\Users\juba dahoumane\Desktop\EasySave-wpf_fini3\Cryptosoft\bin\Debug\netcoreapp3.1\Cryptosoft.exe";
